...
public class MyPreferences {
    ...
    public static boolean isRememberLocation(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.getBoolean("remember_last_location", true);
    }

    public static boolean isRememberProject(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.getBoolean("remember_last_project", true);
    }
    ...
    public static boolean isShowPayeeInTransfers(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.getBoolean("ntsl_show_payee_in_transfers", true);
    }
    ...
    public static boolean isSetFocusOnAmountField(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context).getBoolean("ntsl_set_focus_on_amount_field", true);
    }
    ...
    public static boolean isIncludeTransfersIntoReports(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.getBoolean("include_transfers_into_reports", true);
    }
    ...
    public static boolean isCollapseBlotterButtons(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.getBoolean("collapse_blotter_buttons", true);
    }
    ...
    public static boolean isQuickMenuEnabledForAccount(Context context) {
        return getBoolean(context, "quick_menu_account_enabled", false);
    }
    ...
    public static boolean isSeparateIncomeExpense(Context context) {
        return getBoolean(context, "hierarchical_category_selector_income_expense", true);
    }
